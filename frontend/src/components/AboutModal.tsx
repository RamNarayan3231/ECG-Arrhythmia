...
const GitHubIconLarge: React.FC = () => (
      ...
      >
        ...
        <div className="p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Database to identify five different types of heartbeat patterns: Normal,
              Supraventricular, Ventricular, Fusion, and Unknown beats.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              networks for temporal pattern recognition. Signals are preprocessed using
          ...
          <section>
            ...
            <a
              href="https://github.com/RamNarayan3231/ECG-Arrhythmia"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="bg-gray-50 p-6 rounded-b-xl border-t border-gray-200">
          <p className="text-sm text-gray-600 text-center">
            GNIOT, Greater Noida • Artificial intelligence • 2025
          </p>
        </div>
      </div>
    </div>
